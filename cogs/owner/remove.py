...
class RemoveCommand(commands.Cog):
	...
	@commands.command()
	@commands.is_owner()
	async def remove(self, ctx: commands.Context, discord_user: discord.Member, amount: int):
		...
		embed = discord.Embed(title="GrowBot", description=f"Removed {formatted} from {discord_user.mention} successfully.", color=0x8080ff)
